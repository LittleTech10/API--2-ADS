...
public class CadastroController {
    ...
    public void acessarConfirmacaoCadastro() throws SQLException{
        ...
        if (tamanhoTelaAtual < tamanhoTelaNova && nome.isEmpty() == false && username.isEmpty() == false && senha.isEmpty() == false
                && confirmeSenha.isEmpty() == false && eMail.isEmpty() == false && senha.equals(confirmeSenha) && existeUsername == false && existeEmail == false) {
